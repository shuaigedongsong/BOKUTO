...
(function(w) {
    ...
    function shareText(score) {
        ...
        if (mode === MODE_ENDLESS) {
            if (score <= 5) return '只要冷静下来，就能找到战斗的方法';
            if (score <= 8) return '好——耶！！我是最强的！！';
            if (score <= 10)  return '好——耶！！我是最强的！！';
            if (score <= 15) return '好——耶！！我是最强的！！';
            return '人？';
        } else {
            if (score <= 49) return '只要冷静下来，就能找到战斗的方法';
            if (score <= 99) return '好——耶！！我是最强的！！';
            if (score <= 149) return '好——耶！！我是最强的！！';
            if (score <= 199) return '好——耶！！我是最强的！！';
            return '人？';
        }
    }
